      ...
      <div className="bg-white border-2 border-[#EDEDED] rounded-3xl p-6 shadow-xl transform rotate-3">
        <div className="space-y-5">
          ...
          <div className="flex items-center justify-between">
            <div className="text-lg font-bold font-heading text-[#0C0C0C]">
              lynq.
            </div>
          ...
          <div className="bg-gradient-to-br from-[#FFD93D] to-[#FFC700] rounded-2xl p-4">
            <div className="text-xs font-medium text-[#0C0C0C]/70 mb-1">
              Credit Score
            </div>
            <div className="text-3xl font-bold font-heading text-[#0C0C0C] mb-2">
              640
            </div>
            ...
            <div className="w-full bg-white/30 rounded-full h-1.5 mt-2">
              <div
                className="bg-[#0C0C0C] h-full rounded-full"
                style={{ width: "60%" }}
              ></div>
            </div>
          </div>
          ...
          <div className="bg-[#F6F6F6] rounded-xl p-3">
            ...
            <div className="text-xl font-bold font-heading text-[#0C0C0C]">
              $15 USDC
            </div>
          </div>
          ...
          <div className="bg-[#F6F6F6] rounded-xl p-3 border border-[#EDEDED]">
            <div className="flex items-center justify-between mb-2">
              <div className="text-xs font-semibold text-[#0C0C0C]">
                Active Loan
              </div>
      ...
      <div className="absolute -bottom-8 -left-8 bg-[#0C0C0C] border-2 border-[#EDEDED] rounded-3xl p-6 shadow-xl transform -rotate-6 w-64 z-0">
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="text-2xl font-bold font-heading text-[#FFD93D]">
              $15 USDC
            </div>
          ...
          <div className="pt-2 border-t border-[#8E8E8E]/20">
            ...
            <div className="text-[#8E8E8E] text-xs font-mono">
              0x1234...5678
            </div>
          </div>
        </div>
